...
Logo = f"""    \033[38;5;226m__________________________________________________________________________________
    \033[38;5;0;48;5;226m{timedate.strftime("   %d-%m-%Y   %X   ")}\033[0m
...
def menu():
    ...
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
...
def ansurf():
    ...
    anc = input("[01]Install [02]Run [03]Stop [99]Main Menu >> ")
    if anc == "1":
...
def multitor():
    os.system(
        "echo \"How to stay in multiple places at the same time \" | boxes -d boy | lolcat")
    userchoice = input("[01]Install [02]Run [99]Back >> ")
    if userchoice == "1" or choice == "01":
        os.system("sudo git clone https://github.com/thelinuxchoice/multitor.git")
        anonsurf()
    elif userchoice == "2" or userchoice == "02":
...
def info():
    ...
    [04] 𝘏𝘰𝘴𝘵 𝘛𝘰 𝘐𝘗
    [05] 𝘟𝘦𝘳𝘰𝘴𝘱𝘭𝘰𝘪𝘵
    [06] 𝘙𝘌𝘋 𝘏𝘈𝘞𝘒 (𝘈𝘭𝘭 𝘐𝘯 𝘖𝘯𝘦 𝘚𝘤𝘢𝘯𝘯𝘪𝘯𝘨)
    [07] 𝘙𝘦𝘤𝘰𝘯𝘚𝘱𝘪𝘥𝘦𝘳(𝘍𝘰𝘳 𝘈𝘭𝘭 𝘚𝘤𝘢𝘯𝘪𝘯𝘨)
    [08] 𝘐𝘴𝘐𝘵𝘋𝘰𝘸𝘯 (𝘊𝘩𝘦𝘤𝘬 𝘞𝘦𝘣𝘴𝘪𝘵𝘦 𝘋𝘰𝘸𝘯/𝘜𝘱)
    [09] 𝘐𝘯𝘧𝘰𝘨𝘢 - 𝘌𝘮𝘢𝘪𝘭 𝘖𝘚𝘐𝘕𝘛
    [10] 𝘙𝘦𝘤𝘰𝘯𝘋𝘰𝘨
    [11] 𝘚𝘵𝘳𝘪𝘬𝘦𝘳
    ...
    [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶 
        """)
    choice2 = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
    ...
    if choice2 == "4" or choice2 == "04":
        clearScr()
        h2ip()
    if choice2 == "5" or choice2 == "05":
        clearScr()
        xerosploit()
    if choice2 == "6" or choice2 == "06":
        clearScr()
        redhawk()
    elif choice2 == "7" or choice2 == "07":
        clearScr()
        reconspider()
    elif choice2 == "8" or choice2 == "08":
        clearScr()
        isitdown()
    elif choice2 == "9" or choice2 == "09":
        clearScr()
        infogaemail()
    elif choice2 == "99":
        clearScr()
...
def breacher():
    os.system(
        "echo \"An advanced multithreaded admin panel finder written in python.\n Usage : python breacher -u example.com \n\t [!]https://github.com/s0md3v/Breacher \"|boxes -d boy | lolcat")
    choice = input("[01]Install [99]Back >> ")
    if choice == "1" or choice == "01":
...
def portscanner():
    os.system(
        "echo \"rang3r is a python script which scans in multi thread\n all alive hosts within your range that you specify.\n\t [!]https://github.com/floriankunushevci/rang3r \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
        os.system(
            "git clone https://github.com/floriankunushevci/rang3r; sudo pip install termcolor")
    elif choice == "2" or choice == "02":
...
def nmap():
    nmapchoice = input("[01]Install [99]BAck >> ")
    if nmapchoice == "1":
...
def striker():
    os.system(
        "echo \"Recon & Vulnerability Scanning Suite [!]https://github.com/s0md3v/Striker \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def xerosploit():
    ...
    xeros = input("[01]Install [02]Run [99]Back >> ")
    if xeros == "1":
...
def reconspider():
    os.system(
        "echo \" ReconSpider is most Advanced Open Source Intelligence (OSINT) Framework for scanning IP Address, Emails, \nWebsites, Organizations and find out information from different sources.\n :~python3 reconspider.py \n\t [!]https://github.com/bhavsec/reconspider \" | boxes -d boy | lolcat")
    userchoice = input("[01]Install [99]Back >> ")
    if userchoice == "1" or choice == "01":
...
def setoolkit():
    ...
    choiceset = input("[01]Install [02]Run [99]BAck >>")
    if choiceset == "1":
        os.system(
...
def passwd():
    ...
    print("""   
                ...
                [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶
       """)
    passchoice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
...
def wire():
    ...
    [01] 𝘞𝘪𝘍𝘪-𝘗𝘶𝘮𝘱𝘬𝘪𝘯
    [02] 𝘱𝘪𝘹𝘪𝘦𝘸𝘱𝘴
    [03] 𝘉𝘭𝘶𝘦𝘵𝘰𝘰𝘵𝘩 𝘏𝘰𝘯𝘦𝘺𝘱𝘰𝘵 𝘎𝘜𝘐 𝘍𝘳𝘢𝘮𝘦𝘸𝘰𝘳𝘬
    [04] 𝘍𝘭𝘶𝘹𝘪𝘰𝘯
    [05] 𝘞𝘪𝘧𝘪𝘱𝘩𝘪𝘴𝘩𝘦𝘳
    [06] 𝘞𝘪𝘧𝘪𝘵𝘦
    [07] 𝘌𝘷𝘪𝘭𝘛𝘸𝘪𝘯 
    ...
    [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶 
       """)
    choice4 = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
    if choice4 == "1" or choice4 == "01":
        clearScr()
        wifipumkin()
    if choice4 == "2" or choice4 == "02":
        clearScr()
        pixiewps()
    if choice4 == "3" or choice4 == "03":
        clearScr()
        bluepot()
    if choice4 == "4" or choice4 == "04":
        clearScr()
        fluxion()
    if choice4 == "5" or choice4 == "05":
        clearScr()
        wifiphisher()
    elif choice4 == "6" or choice4 == "06":
        clearScr()
        wifite()
    elif choice4 == "7" or choice4 == "07":
        clearScr()
        eviltwin()
    elif choice4 == "8" or choice4 == "08":
        clearScr()
        howmanypeople()
    elif choice4 == "99":
        menu()
...
def wifipumkin():
    ...
    wp = input("[01]Install [02]Run [99]Back >> ")
    if wp == "1":
...
def pixiewps():
    ...
    choicewps = input("[01]Install [02]Run [99]Back >> ")
    if choicewps == "1":
        os.system(
...
def wifiphisher():
    ...
    wchoice = input("[01]Install [02]Run [99]Back >> ")
    if wchoice == "1":
...
def wifite():
    os.system(
        "echo \"[!]https://github.com/derv82/wifite2 \"|boxes -d boy | lolcat")
    wc = input("[01]Install [02]Run [99]Back >> ")
    if wc == "1":
        os.system("sudo git clone https://github.com/derv82/wifite2.git")
        os.system(
            "cd wifite2 && sudo python3 setup.py install ; sudo pip3 install -r requirements.txt")
        time.sleep(3)
        wire()
    elif wc == "2":
...
def socialattack():
    ...
    print("""
        [01] 𝘐𝘯𝘴𝘵𝘢𝘨𝘳𝘢𝘮 𝘈𝘵𝘵𝘢𝘤𝘬
        [02] 𝘈𝘭𝘭𝘪𝘯𝘖𝘯𝘦 𝘚𝘰𝘤𝘪𝘢𝘭𝘔𝘦𝘥𝘪𝘢 𝘈𝘵𝘵𝘢𝘤𝘬 
        [03] 𝘍𝘢𝘤𝘦𝘣𝘰𝘰𝘬 𝘈𝘵𝘵𝘢𝘤𝘬
        [04] 𝘈𝘱𝘱𝘭𝘪𝘤𝘢𝘵𝘪𝘰𝘯 𝘊𝘩𝘦𝘤𝘬𝘦𝘳
        [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘦𝘯𝘶
    """)
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
    if choice == "1" or choice == "01":
...
def instabrute():
    os.system(
        "echo \"Brute force attack against Instagram \n\t [!]https://github.com/chinoogawa/instaBrute \"| boxes -d boy | lolcat")
    instachoice = input("[01]Install [02]Run [99]Back >> ")
    if instachoice == "1":
        ...
        os.system(
            "cd instaBrute;sudo python instaBrute.py -u {0} -d {1}".format(uname, passinput))
    elif instachoice == "99":
        socialattack()
    else:
        menu()
...
def faceshell():
    os.system(
        "echo \" Facebook BruteForcer[!]https://github.com/Matrix07ksa/Brute_Force \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
        os.system("sudo git clone https://github.com/Matrix07ksa/Brute_Force.git")
        os.system(
        ...
        os.system(
            "cd Brute_Force;python3 Brute_Force.py -f {0} -l {1}".format(uname, passinput))
    elif choice == "99":
        socialattack()
    else:
        menu()
...
def phishattack():
    ...
    [03] 𝘏𝘪𝘥𝘥𝘦𝘯𝘌𝘺𝘦
    [04] 𝘌𝘷𝘪𝘭𝘨𝘪𝘯𝘹2
    [05] 𝘐-𝘚𝘦𝘦_𝘠𝘰𝘶(𝘎𝘦𝘵 𝘓𝘰𝘤𝘢𝘵𝘪𝘰𝘯 𝘶𝘴𝘪𝘯𝘨 𝘱𝘩𝘪𝘴𝘩𝘪𝘯𝘨 𝘢𝘵𝘵𝘢𝘤𝘬) 
    [06] 𝘚𝘢𝘺𝘊𝘩𝘦𝘦𝘴𝘦 (𝘎𝘳𝘢𝘣 𝘵𝘢𝘳𝘨𝘦𝘵'𝘴 𝘞𝘦𝘣𝘤𝘢𝘮 𝘚𝘩𝘰𝘵𝘴)
    [07] 𝘘𝘙 𝘊𝘰𝘥𝘦 𝘑𝘢𝘤𝘬𝘪𝘯𝘨
    [08] 𝘚𝘩𝘦𝘭𝘭𝘗𝘩𝘪𝘴𝘩 
    [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶
       """)
...
def hiddeneye():
    os.system(
        "echo \"Modern Phishing Tool With Advanced Functionality And Multiple Tunnelling Services \n\t [!]https://github.com/DarkSecDevelopers/HiddenEye \"|boxes -d boy | lolcat ")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
        os.system(
...
def saycheese():
    os.system(
        "echo \"Take webcam shots from target just sending a malicious link\"|boxes -d boy | lolcat")
    userchoice = input("[01]Install [02]Run [99]Back >> ")
    if userchoice == "1" or choice == "01":
...
def qrjacking():
    ...
    if userchoice == "1" or choice == "01":
        os.system(
            "sudo git clone https://github.com/cryptedwolf/ohmyqr && sudo apt-get install scrot")
        phishattack()
    elif userchoice == "2" or userchoice == "02":
...
def socialfinder():
    ...
    print("""
        [01] 𝘍𝘪𝘯𝘥 𝘚𝘰𝘤𝘪𝘢𝘭𝘔𝘦𝘥𝘪𝘢 𝘉𝘺 𝘍𝘢𝘤𝘪𝘢𝘭 𝘙𝘦𝘤𝘰𝘨𝘯𝘢𝘵𝘪𝘰𝘯 𝘚𝘺𝘴𝘵𝘦𝘮
        [02] 𝘍𝘪𝘯𝘥 𝘚𝘰𝘤𝘪𝘢𝘭𝘔𝘦𝘥𝘪𝘢 𝘉𝘺 𝘜𝘴𝘦𝘳𝘕𝘢𝘮𝘦
        [03] 𝘚𝘩𝘦𝘳𝘭𝘰𝘤𝘬
        [04] 𝘚𝘰𝘤𝘪𝘢𝘭𝘚𝘤𝘢𝘯 | 𝘜𝘴𝘦𝘳𝘯𝘢𝘮𝘦 𝘰𝘳 𝘌𝘮𝘢𝘪𝘭
        [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶
    """)
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
    if choice == "1" or choice == "01":
...
def socialscan():
    os.system(
        "echo \"Check email address and username availability on online platforms with 100% accuracy \n\t[*]https://github.com/iojw/socialscan \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def forensic():
    ...
    print("""
        ...
        [02] 𝘞𝘪𝘳𝘦𝘴𝘩𝘢𝘳𝘬
        [03] 𝘉𝘶𝘭𝘬_𝘦𝘹𝘵𝘳𝘢𝘤𝘵𝘰𝘳 
        [04] 𝘋𝘪𝘴𝘬 𝘊𝘭𝘰𝘯𝘦 𝘢𝘯𝘥 𝘐𝘚𝘖 𝘐𝘮𝘢𝘨𝘦 𝘈𝘲𝘶𝘪𝘳𝘦
        [05] 𝘛𝘰𝘰𝘭𝘴𝘭𝘦𝘺
        [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶
    """)
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
...
def bulkextractor():
    clearScr()
    os.system("figlet -f Bulk Extractor | lolcat ")
    print("""
        [01] 𝘎𝘜𝘐 𝘔𝘰𝘥𝘦(𝘋𝘰𝘸𝘯𝘭𝘰𝘢𝘥 𝘳𝘦𝘲𝘶𝘪𝘳𝘦𝘥)
        [02] 𝘊𝘓𝘐 𝘔𝘰𝘥𝘦
        [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘦𝘯𝘶
    """)
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
...
def guymager():
    os.system(
        "echo \"Guymager is a free forensic imager for media acquisition.\n [!]https://guymager.sourceforge.io/ \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def autopsy():
    os.system(
        "echo \"Autopsy is a platform that is used by Cyber Investigators.\n[!] Works in any Os\n[!]Recover Deleted Files from any OS & MEdia \n[!]Extract Image Metadata \"|boxes -d boy | lolcat")
    choice = input(" [01]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def toolsley():
    os.system(
        "echo \" Toolsley got more than ten useful tools for investigation.\n[+]File signature verifier\n[+]File identifier \n[+]Hash & Validate \n[+]Binary inspector \n [+]Encode text \n[+]Data URI generator \n[+]Password generator \" | boxes -d boy | lolcat")
    userchoice = input("[01]Open [99]Back >> ")
    if userchoice == "1" or choice == "01":
...
def postexp():
    ...
    print("""
        [01] 𝘝𝘦𝘨𝘪𝘭𝘦 - 𝘎𝘩𝘰𝘴𝘵 𝘐𝘯 𝘛𝘩𝘦 𝘚𝘩𝘦𝘭𝘭
        [02] 𝘊𝘩𝘳𝘰𝘮𝘦 𝘒𝘦𝘺𝘭𝘰𝘨𝘨𝘦𝘳
        [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶 
    """)
    expchoice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
    if expchoice == "1":
        clearScr()
        vegile()
    if expchoice == "2":
...
def vegile():
    ...
    vegilechoice = input("[01]Install [02]Run [99]Back >> ")
    if vegilechoice == "1":
...
def fastssh():
    ...
    if userchoice == "1" or choice == "01":
        os.system(
            "sudo git clone https://github.com/OffXec/fastssh && cd fastssh && sudo chmod +x fastssh.sh")
...
def webAttack():
 ...
 [03] 𝘚𝘶𝘣𝘋𝘰𝘮𝘢𝘪𝘯 𝘍𝘪𝘯𝘥𝘦𝘳
 [04] 𝘊𝘩𝘦𝘤𝘬𝘜𝘙𝘓
 [05] 𝘉𝘭𝘢𝘻𝘺(𝘈𝘭𝘴𝘰 𝘍𝘪𝘯𝘥 𝘊𝘭𝘪𝘤𝘬𝘑𝘢𝘤𝘬𝘪𝘯𝘨)
 [06] 𝘚𝘶𝘣-𝘋𝘰𝘮𝘢𝘪𝘯 𝘛𝘢𝘬𝘦𝘖𝘷𝘦𝘳
 [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶
    """)
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
    if choice == "1" or choice == "01":
...
def web2attack():
    os.system(
        "echo \"Web hacking framework with tools, exploits by python \n[!]https://github.com/santatic/web2attack \"| boxes -d boy | lolcat")
    userchoice = input("[01]Install [02]Run [99]Back >> ")
    if userchoice == "1" or choice == "01":
...
def skipfish():
    os.system(
        "echo \"Skipfish – Fully automated, active web application security reconnaissance tool \n Usage : skipfish -o [FolderName] targetip/site \n[!]https://tools.kali.org/web-applications/skipfish \"|boxes -d headline | lolcat")
    userchoice = input("[01]Run [99]Back >> ")
    if userchoice == "1" or choice == "01":
...
def subdomain():
    os.system(
        "echo \"Sublist3r is a python tool designed to enumerate subdomains of websites using OSINT \n Usage:\n\t[01]python sublist3r.py -d example.com \n[02]python sublist3r.py -d example.com -p 80,443\"| boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def blazy():
    os.system(
        "echo \"Blazy is a modern login page bruteforcer \" | boxes -d boy | lolcat")
    userchoice = input("[01]Install [02]Run [99]Back >> ")
    if userchoice == "1" or choice == "01":
...
def androidhack():
    ...
    print("""
        [01] 𝘒𝘦𝘺𝘥𝘳𝘰𝘪𝘥 
        [02] 𝘔𝘺𝘚𝘔𝘚
        [03] 𝘓𝘰𝘤𝘬𝘱𝘩𝘪𝘴𝘩 (𝘎𝘳𝘢𝘣 𝘵𝘢𝘳𝘨𝘦𝘵 𝘓𝘖𝘊𝘒 𝘗𝘐𝘕)
        [04] 𝘋𝘳𝘰𝘪𝘥𝘊𝘢𝘮 (𝘊𝘢𝘱𝘵𝘶𝘳𝘦 𝘐𝘮𝘢𝘨𝘦)
        [05] 𝘌𝘷𝘪𝘭𝘈𝘱𝘱 (𝘏𝘪𝘫𝘢𝘤𝘬 𝘚𝘦𝘴𝘴𝘪𝘰𝘯)
        [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶
    """)
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
    if choice == "1" or choice == "01":
...
def mysms():
    os.system(
        "echo \" Script that generates an Android App to hack SMS through WAN \n[!]You have to install Some Manually Refer Below Link :\n\t [+]https://github.com/papusingh2sms/mysms \" | boxes -d boy | lolcat")
    userchoice = input("[01]Install [02]Run [99]Back >> ")
    if userchoice == "1" or choice == "01":
...
def lock():
    ...
    if userchoice == "1" or choice == "01":
        os.system(
            "sudo git clone git clone https://github.com/JasonJerry/lockphish")
        androidhack()
    elif userchoice == "2" or userchoice == "02":
...
def droidcam():
    os.system(
        "echo \"Powerful Tool For Grab Front Camera Snap Using A Link  \n[+]https://github.com/kinghacker0/WishFish \"| boxes -d boy | lolcat")
    userchoice = input("[01]Install [02]Run [99]Back >> ")
    if userchoice == "1" or choice == "01":
        os.system(
            "sudo git clone https://github.com/kinghacker0/WishFish; sudo apt install php wget openssh")
        androidhack()
    elif userchoice == "2" or userchoice == "02":
...
def evilapp():
    os.system(
        "echo \"EvilApp is a script to generate Android App that can hijack authenticated sessions in cookies.\n [!]https://github.com/crypticterminal/EvilApp \" | boxes -d boy | lolcat")
    userchoice = input("[01]Install [02]Run [99]Back >> ")
    if userchoice == "1" or choice == "01":
...
def payloads():
    ...
    print("""
        ...
        [02] 𝘉𝘳𝘶𝘵𝘢𝘭
        [03] 𝘚𝘵𝘪𝘵𝘤𝘩
        [04] 𝘔𝘚𝘍𝘷𝘦𝘯𝘰𝘮 𝘗𝘢𝘺𝘭𝘰𝘢𝘥 𝘊𝘳𝘦𝘢𝘵𝘰𝘳
        [05] 𝘝𝘦𝘯𝘰𝘮 𝘚𝘩𝘦𝘭𝘭𝘤𝘰𝘥𝘦 𝘎𝘦𝘯𝘦𝘳𝘢𝘵𝘰𝘳 
        [06] 𝘚𝘱𝘺𝘤𝘢𝘮
        [07] 𝘔𝘰𝘣-𝘋𝘳𝘰𝘪𝘥
        [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶 
    """)
...
def thefatrat():
    ...
    choice = input(
        "[01]Install [02] Run [03]Update [04]TroubleShoot(if not run) [99]Back >>  ")
    if choice == "1" or choice == "01":
...
def wifijammingng():
    os.system(
        "echo \"Continuously jam all wifi clients and access points within range.\n\t [!]https://github.com/MisterBianco/wifijammer-ng \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
        os.system(
...
def whitespace():
    os.system(
        "echo \"Use whitespace and unicode chars for steganography \n\t [!]https://github.com/beardog108/snow10 \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def sqltool():
    ...
    print("""
                    [01] 𝘚𝘲𝘭𝘮𝘢𝘱 𝘵𝘰𝘰𝘭
                    [02] 𝘕𝘰𝘚𝘲𝘭𝘔𝘢𝘱
                    [03] 𝘋𝘢𝘮𝘯 𝘚𝘮𝘢𝘭𝘭 𝘚𝘘𝘓𝘪 𝘚𝘤𝘢𝘯𝘯𝘦𝘳
                    [04] 𝘌𝘹𝘱𝘭𝘰
                    [05] 𝘉𝘭𝘪𝘴𝘲𝘺 - 𝘌𝘹𝘱𝘭𝘰𝘪𝘵 𝘛𝘪𝘮𝘦-𝘣𝘢𝘴𝘦𝘥 𝘣𝘭𝘪𝘯𝘥-𝘚𝘘𝘓 𝘪𝘯𝘫𝘦𝘤𝘵𝘪𝘰𝘯
                    [06] 𝘓𝘦𝘷𝘪𝘢𝘵𝘩𝘢𝘯 - 𝘞𝘪𝘥𝘦 𝘙𝘢𝘯𝘨𝘦 𝘔𝘢𝘴𝘴 𝘈𝘶𝘥𝘪𝘵 𝘛𝘰𝘰𝘭𝘬𝘪𝘵 
                    [07] 𝘚𝘘𝘓𝘚𝘤𝘢𝘯
                    [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶
    """)
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
...
def sqlscan():
    os.system(
        "echo \"sqlscan is quick web scanner for find an sql inject point. not for educational, this is for hacking. \n [!]https://github.com/Cvar1984/sqlscan \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def explo():
    os.system(
        "echo \"explo is a simple tool to describe web security issues in a human and machine readable format.\n Usage :- \n [01]explo [--verbose|-v] testcase.yaml \n [02]explo [--verbose|-v] examples/*.yaml \n[*]https://github.com/dtag-dev-sec/explo \"|boxes -d boy | lolcat")
    choice = input("[01]Install [99]Back >> ")
    if choice == "1" or choice == "01":
...
def others():
    clearScr()
    print(Logo + """
    [01] 𝘚𝘰𝘤𝘪𝘢𝘭𝘔𝘦𝘥𝘪𝘢 𝘈𝘵𝘵𝘢𝘤𝘬 
    [02] 𝘈𝘯𝘥𝘳𝘰𝘪𝘥 𝘏𝘢𝘤𝘬
    [03] 𝘏𝘢𝘵𝘊𝘭𝘰𝘶𝘥(𝘉𝘺𝘱𝘢𝘴𝘴 𝘊𝘭𝘰𝘶𝘥𝘍𝘭𝘢𝘳𝘦 𝘧𝘰𝘳 𝘐𝘗)
    [04] 𝘐𝘋𝘕 𝘏𝘰𝘮𝘰𝘨𝘳𝘢𝘱𝘩 𝘈𝘵𝘵𝘢𝘤𝘬 𝘛𝘰𝘰𝘭𝘴
    [05] 𝘌𝘮𝘢𝘪𝘭 𝘝𝘦𝘳𝘪𝘧𝘪𝘦𝘳
    [06] 𝘏𝘢𝘴𝘩 𝘊𝘳𝘢𝘤𝘬𝘪𝘯𝘨 𝘛𝘰𝘰𝘭𝘴
    [99] 𝘉𝘢𝘤𝘬 𝘛𝘰 𝘔𝘢𝘪𝘯 𝘔𝘦𝘯𝘶
    """)
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
    if choice == "1" or choice == "01":
...
def hatcloud():
    os.system(
        "echo \"HatCloud build in Ruby. It makes bypass in CloudFlare for discover real IP.\n\b [!]https://github.com/HatBashBR/HatCloud \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def knockmail():
    os.system(
        "echo \"KnockMail Tool Verify If Email Exists [!]https://github.com/4w4k3/KnockMail \"|boxes -d boy | lolcat")
    choice = input("[01]Install [99]Back >> ")
    if choice == "1" or choice == "01":
...
def evilurl():
    os.system(
        "echo \"Generate unicode evil domains for IDN Homograph Attack and detect them. \n [!]https://github.com/UndeadSec/EvilURL \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def Ddos():
    ...
    print("""
        [01]𝘚𝘭𝘰𝘸𝘓𝘰𝘳𝘪𝘴
        [02]𝘢𝘚𝘠𝘕𝘤𝘳𝘰𝘯𝘦 | 𝘔𝘶𝘭𝘵𝘪𝘧𝘶𝘯𝘤𝘵𝘪𝘰𝘯 𝘚𝘠𝘕 𝘍𝘭𝘰𝘰𝘥 𝘋𝘋𝘰𝘚 𝘞𝘦𝘢𝘱𝘰𝘯 
        [03]𝘜𝘍𝘖𝘯𝘦𝘵
        [04]𝘎𝘰𝘭𝘥𝘦𝘯𝘌𝘺𝘦
        [99]𝘉𝘢𝘤𝘬
    """)
...
def asyncrone():
    ...
    if choice == "1" or choice == "01":
        ...
        os.system(
            "cd aSYNcrone;sudo ./aSYNcrone {0} {1} {2} 1000".format(sport, tip, tport))
    elif choice == "99":
        Ddos()
    else:
        menu()
...
def goldeneye():
    os.system(
        "echo \"GoldenEye is an python3 app for SECURITY TESTING PURPOSES ONLY!\nGoldenEye is a HTTP DoS Test Tool. \n\t [!]https://github.com/jseidl/GoldenEye \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
        os.system(
            "sudo git clone https://github.com/jseidl/GoldenEye.git;chmod -R 755 GoldenEye")
        Ddos()
    elif choice == "2" or choice == "02":
...
def xsstools():
    ...
    print("""
        [01] 𝘋𝘢𝘭𝘍𝘰𝘹(𝘍𝘪𝘯𝘥𝘦𝘳 𝘰𝘧 𝘟𝘚𝘚)
        [02] 𝘟𝘚𝘚 𝘗𝘢𝘺𝘭𝘰𝘢𝘥 𝘎𝘦𝘯𝘦𝘳𝘢𝘵𝘰𝘳
        [03] 𝘌𝘹𝘵𝘦𝘯𝘥𝘦𝘥 𝘟𝘚𝘚 𝘚𝘦𝘢𝘳𝘤𝘩𝘦𝘳 𝘢𝘯𝘥 𝘍𝘪𝘯𝘥𝘦𝘳
        [04] 𝘟𝘚𝘚-𝘍𝘳𝘦𝘢𝘬
        [05] 𝘟𝘚𝘱𝘦𝘢𝘳 
        [06] 𝘟𝘚𝘚𝘊𝘰𝘯
        [07] 𝘟𝘢𝘯𝘟𝘚𝘚
        [08] 𝘈𝘥𝘷𝘢𝘯𝘤𝘦𝘥 𝘟𝘚𝘚 𝘋𝘦𝘵𝘦𝘤𝘵𝘪𝘰𝘯 𝘚𝘶𝘪𝘵𝘦
        [99] 𝘉𝘈𝘤𝘬
    """)
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
    if choice == "1" or choice == "01":
...
def dalfox():
    os.system(
        "echo \"XSS Scanning and Parameter Analysis tool.\"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
        ...
        print(
            "\033[96m You Need To Run manually by using  [!]~/go/bin/dalfox [options] ")
    elif choice == "99":
        xsstools()
    else:
        others()
...
def xsspayload():
    os.system(
        "echo \" XSS PAYLOAD GENERATOR -XSS SCANNER-XSS DORK FINDER \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def xssfreak():
    os.system(
        "echo \" XSS-Freak is an XSS scanner fully written in python3 from scratch\n\b [!]https://github.com/PR0PH3CY33/XSS-Freak \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def xsscon():
    os.system(
        "echo \" [!]https://github.com/menkrep1337/XSSCon \"|boxes -d boy | lolcat")
    choice = input("[01]Install [02]Run [99]Back >> ")
    if choice == "1" or choice == "01":
...
def update():
    print("""
        [01] 𝘜𝘱𝘥𝘢𝘵𝘦 𝘛𝘰𝘰𝘭 𝘰𝘳 𝘚𝘺𝘴𝘵𝘦𝘮 
        [02] 𝘜𝘯𝘪𝘯𝘴𝘵𝘢𝘭𝘭 𝘕𝘦𝘵𝘳𝘶𝘯𝘯𝘦𝘳
        [99]𝘉𝘢𝘤𝘬
    """)
    choice = input("\033[96m几乇ㄒ尺ㄩ几几乇尺 >> \033[0m")
    if choice == "1" or choice == "01":
...
def updatesys():
    choice = input("[01]Update System [02]Update Netrunner [99]Back >> ")
    if choice == "1" or choice == "01":
...
def uninstall():
    choice = input("[01]Uninstall [99]Back >> ")
    if choice == "1" or choice == "01":
...
if __name__ == "__main__":
    try:
        if system() == 'Linux':
            fpath = "/home/ruda0/netrunner/Netrunnerpath.txt"
